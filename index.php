...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<div class="text-light text-center">&copy; <?php echo date('Y')?> - Developed By Manshi Under the Guidance of Online Learning Source<br><br></div>
	<!-- <p>----------</p> -->
	<!-- <p>Sujoy Dcunha, Christina Pereira, Mark Coutinho</p> -->
